...
I used c# which is a general-purpose, object-oriented programming language used to create software. Most of my project does not use any other libraries in this program yet, but I have been playing with some libraries for dealing with graphs and many different libraries to make application windows.
...
- [chatgpt](https://chatgpt.com): Chatgpt was extremely useful to ask question to for info that I could look up else where. Note: I did not take any code from this chatgpt. chatgpt is like the wiki. Useful for getting quick info, but not reliable in any way. 

list of things that I need to fix or improve in the future:
- finish the ai player for tic tac toe. aka the random number gen loop
- finish the player movement classes for the chess game
